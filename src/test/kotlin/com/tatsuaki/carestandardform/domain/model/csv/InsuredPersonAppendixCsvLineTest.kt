...
class InsuredPersonAppendixCsvLineTest {
    ...
    fun getMethodTest() {
        ...
        assertEquals("サービス種類1", insuredPersonAppendixCsvLine.serviceKindCode1)
        ...
        assertEquals("サービス種類2", insuredPersonAppendixCsvLine.serviceKindCode2)
        ...
        assertEquals("サービス種類3", insuredPersonAppendixCsvLine.serviceKindCode3)
        ...
        assertEquals("サービス種類4", insuredPersonAppendixCsvLine.serviceKindCode4)
        ...
        assertEquals("サービス種類5", insuredPersonAppendixCsvLine.serviceKindCode5)
        ...
        assertEquals("サービス種類6", insuredPersonAppendixCsvLine.serviceKindCode6)
        ...
        assertEquals("サービス種類7", insuredPersonAppendixCsvLine.serviceKindCode7)
        ...
        assertEquals("サービス種類8", insuredPersonAppendixCsvLine.serviceKindCode8)
        ...
        assertEquals("サービス種類9", insuredPersonAppendixCsvLine.serviceKindCode9)
